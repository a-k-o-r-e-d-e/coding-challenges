...
function bruteForceDisappearingPairs(str: string): string {
  while (str.includes("AA") || str.includes("BB") || str.includes("CC")) {
    str = str.replace("AA", "");
    str = str.replace("BB", "");
    str = str.replace("CC", "");
  }
...
console.log(bruteForceDisappearingPairs("ACCAABBC")); // "AC"
console.log(bruteForceDisappearingPairs("ABCBBCBA")); // ""
console.log(bruteForceDisappearingPairs("BABABA")); // "BABABA"


console.log("****Efficient Disappearing Pairs ****");
function efficientDisappearingPairs(str: string) : string {
    // base case 
    if (str.length === 0) {
        return str;
    }
...
console.log(efficientDisappearingPairs("ACCAABBC")); // "AC"
console.log(efficientDisappearingPairs("ABCBBCBA")); // ""
console.log(efficientDisappearingPairs("BABABA")); // "BABABA"
