...
function removeStarsStackSolution(s: string): string {
...
function removeStars2PointerSolution(s: string): string {
    // Approach
  ...
  for (let seeker = 0; seeker < s.length; seeker++) {
    //   const v = s[i];
    if (chars[seeker] === "*") {
      writer--;
    } else {
...
console.log("Result ::", removeStars2PointerSolution("leet**cod*e"));
console.log("Result ::", removeStars2PointerSolution("erase*****"));
console.log("Result ::", removeStars2PointerSolution("*****"));
console.log("Result ::", removeStars2PointerSolution("erase"));
console.log("Result ::", removeStars2PointerSolution(""));